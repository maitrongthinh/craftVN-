...
if (args.task_path) {
    try {
        ...
        console.error(`Error: Failed to load or parse task file at '${args.task_path}': ${err.message}`);
        process.exit(1);
    }
}
...
CraftVN.init(true, settings.mindserver_port, settings.auto_open_ui);
