...
export class SelfPrompter {
    ...
    async startLoop() {
        ...
        while (!this.interrupt) {
            let msg = `You are self-prompting with the goal: '${this.prompt}'. Your next response MUST contain a command with this syntax: !commandName.`;
            
            // Only strictly enforce !endGoal in assistant mode, otherwise let AI decide
            if (settings.base_profile === 'assistant') {
                msg += ` IMPORTANT: If you have fully completed the goal, you MUST use !endGoal to stop. Do NOT keep looping after the goal is done.`;
            }
            msg += ` Respond:`;
